...
const root = fs.mkdtempSync(path.join(os.tmpdir(), "atlas-structured-ui-"));
      ...
      requirements: [
        {
          ...
          assessment: "已有平台需求与上线经历，可进一步补充协作过程。",
          evidenceIds: ["fixture"],
        },
        {
          requirement: "英语沟通能力",
...
const serverPromise = a.startAtlasServer(
  ...
  Number(process.env.ATLAS_FIXTURE_PORT) || 5182,
);
